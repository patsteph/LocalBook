...
CURATOR_INTENTS: List[Dict[str, str]] = [
    ...
    {"id": "discover_patterns", "desc": "User wants to DISCOVER patterns, themes, trends, or connections ACROSS their notebooks — asking what links/connects/recurs, not a specific fact. Trigger phrasings: 'what patterns exist across my notebooks', 'what themes connect my research', 'find common threads', 'what links these topics', 'what's recurring across my notes'. Whenever the message is about patterns/themes/trends/connections rather than a specific answerable fact, choose THIS over cross_notebook_search.", "params": "none"},
    ...
    {"id": "cross_notebook_search", "desc": "User is asking a SPECIFIC, answerable question that requires searching across notebooks for a fact or summary (the default fallback for general questions) — e.g. 'what did I save about X', 'what does my research say about Y', 'summarize what I know about Z'. Do NOT use this for pattern/theme/trend/connection DISCOVERY ('what patterns exist', 'what connects my research', 'find common threads') — those are discover_patterns.", "params": "query: the search question"},
]
